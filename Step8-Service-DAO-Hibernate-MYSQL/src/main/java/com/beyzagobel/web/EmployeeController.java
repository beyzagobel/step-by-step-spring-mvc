...
public class EmployeeController {
    ...
    public @ResponseBody String kaydet(@RequestParam(required = false) Long employeeId,@RequestParam String fname, @RequestParam String lname,
                                       @RequestParam String bdate,@RequestParam int gender){
